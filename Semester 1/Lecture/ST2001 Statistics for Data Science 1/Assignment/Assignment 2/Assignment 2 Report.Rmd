...
The boxplot of the data below also uses Tukey's method. I would describe the shape of the distribution using the boxplot as left skewed.
...
A histogram is given below. I would describe the shape of the distribution using the histogram as right skewed.
